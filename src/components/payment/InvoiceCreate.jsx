...
const InvoiceCreate = ({ masterData = [] }) => {
    ...
    const total = Number(subTotal + Number(vat)).toFixed(2)

    async function handleSubmit(formData) {
        // Append complex data
        formData.append('items', JSON.stringify(items));
        formData.append('issueDate', startDate?.toISOString() || '');
        formData.append('dueDate', endDate?.toISOString() || '');
        formData.append('total', total);
        formData.append('subTotal', subTotal);
        formData.append('tax', vat);
    ...
    return (
        ...
        }} id="invoice-form" className="w-100">
                        ...
                        <div className="card-body p-0">
                            <div className="px-4 pt-4">
                                <div className="d-md-flex align-items-center justify-content-between">
                                    <div className="mb-4 mb-md-0 your-brand">
                                        <label htmlFor='img' className="wd-100 ht-100 mb-0 position-relative overflow-hidden border border-gray-2 rounded d-flex align-items-center justify-content-center bg-light">
                                            {uploadedImage ? (
                                                <img src={uploadedImage} className="upload-pic img-fluid rounded h-100 w-100" alt="Uploaded" />
                                            ) : (
                                                <span className="fw-bold text-muted text-center p-1 lh-1">Your Logo</span>
                                            )}
                            ...
                            <div className="px-4 row justify-content-between">
                                <div className="col-xl-3">
                                    <div className="form-group mb-3">
                                        ...
                                        <input type="text" name="label" className="form-control" id="InvoiceLabel" placeholder="Duralux Invoice" />
                                    </div>
                                </div>
                                <div className="col-xl-3">
                                    <div className="form-group mb-3">
                                        <label htmlFor="InvoiceNumber" className="form-label">Invoice Number</label>
                                        <input type="text" name="invoiceNumber" className="form-control" id="InvoiceNumber" placeholder="#NXL2023" />
                                    </div>
                                </div>
                                <div className="col-xl-6">
                                    <div className="form-group mb-3">
                                        <label htmlFor="InvoiceProduct" className="form-label">Invoice Product</label>
                                        <input type="text" name="product" className="form-control" id="InvoiceProduct" placeholder="Product Name" />
                                    </div>
                                </div>
                            </div>
                            <hr className="border-dashed" />
                            <div className="row px-4 justify-content-between">
                                <div className="col-xl-5 mb-4 mb-sm-0">
                                    ...
                                    <div className="form-group row mb-3">
                                        ...
                                        <div className="col-sm-9">
                                            <input type="text" name="senderName" className="form-control" id="InvoiceName" placeholder="Business Name" />
                                        </div>
                                    </div>
                                    <div className="form-group row mb-3">
                                        <label htmlFor="InvoiceEmail" className="col-sm-3 col-form-label">Email</label>
                                        <div className="col-sm-9">
                                            <input type="text" name="senderEmail" className="form-control" id="InvoiceEmail" placeholder="Email Address" />
                                        </div>
                                    </div>
                                    <div className="form-group row mb-3">
                                        <label htmlFor="InvoicePhone" className="col-sm-3 col-form-label">Phone</label>
                                        <div className="col-sm-9">
                                            <input type="text" name="senderPhone" className="form-control" id="InvoicePhone" placeholder="Enter Phone" />
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        <label htmlFor="InvoiceAddress" className="col-sm-3 col-form-label">Address</label>
                                        <div className="col-sm-9">
                                            <textarea rows={5} name="senderAddress" className="form-control" id="InvoiceAddress" placeholder="Enter Address" defaultValue={""} />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-5">
                                    ...
                                    <div className="form-group row mb-3">
                                        ...
                                        <div className="col-sm-9">
                                            <input type="text" name="clientName" className="form-control" id="ClientName" placeholder="Business Name" />
                                        </div>
                                    </div>
                                    <div className="form-group row mb-3">
                                        <label htmlFor="ClientEmail" className="col-sm-3 col-form-label">Email</label>
                                        <div className="col-sm-9">
                                            <input type="text" name="clientEmail" className="form-control" id="ClientEmail" placeholder="Email Address" />
                                        </div>
                                    </div>
                                    <div className="form-group row mb-3">
                                        <label htmlFor="ClientPhone" className="col-sm-3 col-form-label">Phone</label>
                                        <div className="col-sm-9">
                                            <input type="text" name="clientPhone" className="form-control" id="ClientPhone" placeholder="Enter Phone" />
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        <label htmlFor="ClientAddress" className="col-sm-3 col-form-label">Address</label>
                                        <div className="col-sm-9">
                                            <textarea rows={5} name="clientAddress" className="form-control" id="ClientAddress" placeholder="Enter Address" defaultValue={""} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    return (
                                                        <tr key={index}>
                                                            ...
                                                            <td>
                                                                ...
                                                                />
                                                                <datalist id={`master-data-${id}`}>
                                                                    {masterData.map((m, i) => (
                                                                        <option key={i} value={m.name}>{m.name} - ${m.price} ({m.type})</option>
                                                                    ))}
                                                                </datalist>
                                                            </td>
                                                            ...
                                                            <td><input type="number" name="price" placeholder="Unit Price" className="form-control price" step="1.00" min="0" value={price} onChange={(e) => handleInputChange(id, 'price', parseFloat(e.target.value))} /></td>
                            ...
                            <div className="px-4 pb-4">
                                <div className="form-group">
                                    ...
                                    <textarea rows={6} name="note" className="form-control" id="InvoiceNote" placeholder="It was a pleasure working with you and your team. We hope you will keep us in mind for future freelance projects. Thank You!" defaultValue={""} />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-xl-4">
                    ...
                    <div className="card stretch stretch-full">
                        <div className="card-body">
                            ...
                            <button type="submit" className="btn btn-primary w-100 mt-4">Create Invoice</button>
                        </div>
                    </div>
                    <div className="card stretch stretch-full">
                        <div className="card-body">
